...
# Apps
paru -Syu --needed --noconfirm brave-bin wezterm kitty alacritty zstd mlocate mpv bat bat-extras fastfetch lolcat bind \
...
pamac okular gitnuro-bin xclicker freetube pkgfile man-pages openvpn networkmanager-openvpn mcomix spotify spotifywm \
spicetify-cli spicetify-marketplace-bin wget nodejs npm gvfs gvfs-mtp android-tools virtualbox cava zoxide yazi \
bluez bluez-utils blueman tela-circle-icon-theme-dracula
